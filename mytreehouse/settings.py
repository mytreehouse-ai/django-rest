...
DATA_UPLOAD_MAX_MEMORY_SIZE = 10485760  # 10 MB limit for data upload size
...
STATIC_URL = '/static/' if env(
    'NODE_ENV') == 'development' else "https://kmc-s3.sgp1.cdn.digitaloceanspaces.com/django-rest/mytreehouse/static/"
