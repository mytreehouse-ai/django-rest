...
from ...services.lanchain_openai_services import LangchainOpenAIServices, MongoDBConnector

# Configure logger for this module
logger = logging.getLogger(__name__)

# Long text containing various FAQs related to industrial real estate
long_text = """
## FAQ on Industrial:
